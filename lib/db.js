...
async function createAgent(userId, agentName, agentKey) {
  if (useMemory) {
    ...
    const agent = { id, user_id: userId, agent_name: agentName, agent_key: agentKey, status: 'offline', local_ip: null, os_info: null, version: '1.0.0', created_at: new Date().toISOString() };
